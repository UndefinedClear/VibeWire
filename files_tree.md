...
### Файл: Backend\no_bg.png *(бинарный файл)*

### Файл: Backend\np_bg.ico *(бинарный файл)*
...
### Файл: Backend\with_bg.ico *(бинарный файл)*

### Файл: Backend\with_bg.jpeg *(бинарный файл)*
...
### Файл: Backend\uploads\music\1764167980219.mp3 *(бинарный файл)*
...
:root {
    ...
    --background: #0f0c24;
    --surface: #1a1438;
    --surface-variant: #2a2252;
    --on-primary: #ffffff;
    --on-background: #ffffff;
    --on-surface: #ffffff;
    --on-surface-variant: #d1c4e9;
    --elevation-1: rgba(138, 43, 226, 0.1);
    --elevation-2: rgba(138, 43, 226, 0.2);
    --elevation-3: rgba(138, 43, 226, 0.3);
    --gradient-purple: linear-gradient(135deg, #6a11cb 0%, #2575fc 100%);
    --gradient-dark: linear-gradient(to bottom right, #0f0c24, #1a1438);
}
body {
...
.font-bold {
    ...
    <link rel="icon" href="/assets/no_bg.png">
    <!-- <link rel="icon" href="/assets/with_bg.jpeg"> -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
</head>
<body>
    <div id="auth" class="auth-modal">
        <h2 style="color: white; text-align: center; margin-bottom: 24px;">Login to Your Account</h2>
        <div class="input-group">
            <input type="text" id="username" placeholder="Username" style="background: rgba(255, 255, 255, 0.1); border: none; border-radius: 4px; color: white; padding: 12px; width: 100%; margin-bottom: 16px;">
        </div>
        <div class="input-group">
            <input type="password" id="password" placeholder="Password" style="background: rgba(255, 255, 255, 0.1); border: none; border-radius: 4px; color: white; padding: 12px; width: 100%; margin-bottom: 24px;">
        </div>
        <div style="display: flex; gap: 12px; margin-top: 24px;">
            <button onclick="register()" style="flex: 1; padding: 12px; background: var(--primary); color: white; border: none; border-radius: 20px; font-weight: bold; cursor: pointer; transition: all 0.2s;">SIGN UP</button>
            <button onclick="login()" style="flex: 1; padding: 12px; background: var(--primary-light); color: white; border: none; border-radius: 20px; font-weight: bold; cursor: pointer; transition: all 0.2s;">LOG IN</button>
        </div>
        <div id="auth-msg" style="margin-top: 16px; color: #b3b3b3; text-align: center;"></div>
    </div>
    <div id="main" class="container" style="display:none; background: var(--gradient-dark);">
<aside class="sidebar">
            <!-- <div class="logo"> -->
        ...
        <header class="header-container">
            <div class="logo">
                <!-- <img src="https://storage.googleapis.com/pr-newsroom-wp/1/2018/11/Spotify_Logo_RGB_White.png" alt="Spotify Logo" height="40"> -->

                <img src="/assets/no_bg.png" alt="" height="100">
            </div>
            <div class="search-container" style="flex: 1; margin: 0 24px;">
